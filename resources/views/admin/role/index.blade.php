...
<div class="page-container">
	<div class="cl pd-5 bg-1 bk-gray"> 
		<span class="l"> 
			...
			<a href="javascript:;" onclick="location.href='/admin/index/export'" class="btn btn-primary radius">
	...
	<table class="table table-border table-bordered table-hover table-bg">
		...
		<tbody>
			...
			<tr class="text-c">
				...
				<td>{{$val -> auth_ac}}</td>
				<td class="f-14">
				<a title="分配权限" href="javascript:;" onclick="admin_role_assign('分配权限','/admin/role/assign','{{$val -> id}}')" style="text-decoration:none"><i class="Hui-iconfont">&#xe603;</i></a>

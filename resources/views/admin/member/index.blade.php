	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			...
			<tr class="text-c">
				...
				<td>
					<a href="javascript:;" onclick="member_play_video('{{$val -> video}}','/admin/member/video?id={{$val -> id}}','','510')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i>play video</a>
				</td>
				<td>
					@if($val ->gender == '1')
					Man
...
/*用户-播放视频*/
function member_play_video(title,url,w,h){
	layer_show(title,url,w,h);
}
/*用户-停用*/
